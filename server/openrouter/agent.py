...
LOCAL_TOOL_SCHEMAS = [
    ...
    _tool("bash", "Run a Bash command in the workspace.", {"executable": {"type": "string"}, "arguments": {"type": "array", "items": {"type": "string"}}, "working_directory": {"type": "string"}, "timeout_seconds": {"type": "integer"}, "environment": {"type": "object"}, "stdin": {"type": "string", "maxLength": 256000}}, ["executable", "arguments"]),
