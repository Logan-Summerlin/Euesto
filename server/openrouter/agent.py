...
LOCAL_TOOL_SCHEMAS = [
    _tool("read", "Read a UTF-8 text file.", {"path": {"type": "string"}, "start_line": {"type": "integer", "minimum": 1}, "end_line": {"type": "integer", "minimum": 1}, "max_bytes": {"type": "integer", "minimum": 1, "maximum": 256000}}, ["path"]),
    ...
    _tool("bash", "Run a non-interactive Bash command in the staged workspace.", {"command": {"type": "string"}, "working_directory": {"type": "string"}, "timeout_seconds": {"type": "integer", "minimum": 1, "maximum": 300}, "env": {"type": "object"}, "stdin": {"type": "string", "maxLength": 256000}}, ["command"]),
