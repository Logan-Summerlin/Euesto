...
LOCAL_TOOL_SCHEMAS = [
    {
        ...
        "function": {
            "name": "list_files",
            "description": "List paths; details adds size, include_sha256 adds hashes (100 max).",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            "name": "read_file",
            "description": "Read UTF-8 text; metadata includes full-file hash and size.",
            "parameters": {
                "type": "object",
                "properties": {
                    "path": {"type": "string"},
    ...
    },
    {
        ...
        "function": {
            "name": "search_text",
            "description": "Search text; results include path and line, with optional context.",
            "parameters": {
                "type": "object",
                "required": ["query"],
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "List source-to-staging changes and optional bounded diffs.",
            "parameters": {
                "type": "object",
                "properties": {
                    ...
                    "max_diff_bytes": {"type": "integer", "minimum": 1, "maximum": 256000},
                    "max_diff_lines": {"type": "integer", "minimum": 1, "maximum": 2000},
                },
                "additionalProperties": False,
            },
        },
    },
    {
        ...
        "function": {
            ...
            "description": "Inspect a pre-mutation snapshot or diff it to current staging.",
            "parameters": {
                "type": "object",
    ...
    },
    {
        ...
        "function": {
            "name": "move_file",
            "description": "Hash-checked staged move; returns a pre-operation checkpoint.",
            "parameters": {
                "type": "object",
    ...
    },
    {
        ...
        "function": {
            "name": "copy_file",
            "description": "Hash-checked staged copy; returns a pre-operation checkpoint.",
            "parameters": {
                "type": "object",
                "required": ["source", "destination", "expected_sha256"],
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Preview or restore an entire pre-mutation staging checkpoint.",
            "parameters": {
                "type": "object",
                "required": ["checkpoint_id"],
                "properties": {
...
async def agent_turn(
    ...
    payload = {
        ...
        "usage": {"include": True},
        "provider": {
            "data_collection": "allow" if privacy.get("data_collection") == "allow" else "deny",
            "zdr": bool(privacy.get("zdr", False)),
        },
    }
    headers = {
        ...
        async with httpx.AsyncClient(timeout=90, follow_redirects=False) as client:
            ...
            if response.status_code >= 400:
                raise ProviderError(
                    ...
                    f"OpenRouter agent request failed ({response.status_code}).",
                    retryable=response.status_code >= 500,
                )
            data = response.json()
    except httpx.HTTPError as exc:
        raise ProviderError(
            "provider.connection", f"Agent request failed: {exc}", retryable=True
        ) from exc
    choices = data.get("choices") or []
    if not choices or not isinstance(choices[0].get("message"), dict):
        raise ProviderError(
            "provider.invalid_agent_response", "OpenRouter returned no agent message."
        )
